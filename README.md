## Lightimer
A handy countdown timer for mastering time management in [Lighting Talks](https://en.wikipedia.org/wiki/Lightning_talk) or other short presentations. It works for Linux, Windows and probably on Mac (not tested yet).
